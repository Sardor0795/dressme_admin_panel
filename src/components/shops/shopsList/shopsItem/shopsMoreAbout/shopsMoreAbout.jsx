            ...
            <div className="h-full w-full  rounded-lg overflow-hidden flex items-center justify-center ">
              {!shopData?.url_background_photo ? (
                <div className="w-fit h-fit flex items-center">
                  <span className="leading-none text-[13px] md:text-base font-AeonikProRegular md:font-AeonikProMedium text-textBlueColor">
                    Фоновое фото
                  </span>
                </div>
              ) : (
          ...
          <div className="w-full flex items-center justify-end mb-[24px] md:mb-20 mt-4">
            <div className="flex items-center">
              ...
              >
                ...
                <span className="w-fit text-weatherWinterColor hover:underline cursor-pointer text-[13px] ll:text-[13px] md:text-base not-italic font-AeonikProMedium">
                  Все локации
                </span>
              </NavLink>
            </div>
